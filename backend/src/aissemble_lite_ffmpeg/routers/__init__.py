...
This package support more complex routes, should you want to configure any.
A default healthcheck route is provided both as an example and for convenience.
"""
